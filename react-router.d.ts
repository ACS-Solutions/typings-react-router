...
declare module ReactRouter {
	...
	type RouteConfig = React.ReactElement<any> | React.ReactNode | PlainRoute | PlainRoute[];
	...
	export interface IRouterProps {
		 ...
		 * @param {IProps} props
		 */
		createElement?<IProps>(component: ReactComponent<IProps>, props: IProps): React.ClassicElement<IProps>;
		 ...
		 */
		render?<IProps>(props: IProps): React.ClassicElement<IProps>;
	}
